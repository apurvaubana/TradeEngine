package com.jp.trade.api.advice;
...
import com.jp.trade.api.model.response.ErrorMessage;
import com.jp.trade.service.exception.TradeEngineServiceException;

/**
 * This class handles exception for the controllers.
 *
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	/**
	 * Exception method handler for TradeEngineServiceException class.
	 *
	 * @param ex
	 ...
	 * @return ResponseEntity
	 */
	@ExceptionHandler(value = { TradeEngineServiceException.class })
	protected ResponseEntity<Object> bussinessException(TradeEngineServiceException ex, WebRequest webRequest) {
		logger.error(ex);
		if (null != ex.getCause()) {
	...
	/**
	 * This method will catch BAD_REQUEST exceptions thrown during the validation
	 * phase.
	 *
	 * @param ex
	 *            the exception
